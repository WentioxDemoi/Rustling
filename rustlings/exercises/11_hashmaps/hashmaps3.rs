...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        //     let aller = scores.get_mut(team_1_name).unwrap();
        //     aller.goals_conceded += team_2_score;
        //     aller.goals_scored += team_1_score
        // } else {
        //     scores.insert(team_1_name, TeamScores {goals_scored: team_1_score,  goals_conceded: team_2_score});
        // }

        // if scores.contains_key(team_2_name) {
        //     let aller = scores.get_mut(team_2_name).unwrap();
        //     aller.goals_conceded += team_1_score;
        //     aller.goals_scored += team_2_score
        // } else {
